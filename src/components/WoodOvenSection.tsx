export default function WoodOvenSection() {
  return (
    <section id="forno" className="bg-[#f9f8ed] text-[#1e1e1e] py-20 sm:py-24 lg:py-32 relative overflow-hidden border-t border-[#e8e4d3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          
          {/* Left Column: Visual of the traditional wood oven */}
          <div className="lg:col-span-6 order-2 lg:order-1 relative flex items-center justify-center z-10 w-full">
            <img
              src="https://raw.githubusercontent.com/andersoneloydesigner/Forneria-O-Paulistano/f8382db8c29f2c85e30d0408be88918887b427de/forno.png"
              alt="Forno a lenha tradicional em brasa"
